...
class CrosCodecsDecoder(Decoder):
    ...
    def decode(
        ...
        if output_format == OutputFormat.YUV420P:
            output_fmt = "i420"
        elif output_format == OutputFormat.YUV422P:
            output_fmt = "i422"
        elif output_format == OutputFormat.YUV420P10LE:
            output_fmt = "i010"
        elif output_format == OutputFormat.YUV420P12LE:
            output_fmt = "i012"
        elif output_format == OutputFormat.YUV422P10LE:
            output_fmt = "i210"
        elif output_format == OutputFormat.YUV422P12LE:
            output_fmt = "i212"
        elif output_format == OutputFormat.YUV444:
            output_fmt = "i444"
        elif output_format == OutputFormat.YUV444P10LE:
            output_fmt = "i410"
        elif output_format == OutputFormat.YUV444P12LE:
            output_fmt = "i412"
        else:
        ...
        run_command(
            [self.binary, input_filepath, "--output", output_filepath, "--input-format", input_fmt, "--output-format", output_fmt],
            timeout=timeout,
            verbose=verbose,
        )
